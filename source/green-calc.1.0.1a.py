...
if rozpocznij==1:
    ...
    while True:
        try:
            ...
            print('popraw dane')
    print('Podaj średnie zużycie roczne (MWh)')
    while True:
        try:
            zuzycie=float(input())
            break
    ...
    print('Szacunkowo twoja instalacja pozwoli Ci na wykorzystanie:', round(produkcja, 2), 'MWh')
    ...
    print('Szacunkowa nadprodukcja energii wynosi', round(nadprodukcja, 2), 'MWh')
